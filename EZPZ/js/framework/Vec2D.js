...
class Rect2D {
	...
	// if boarders are exactly touching or overlapped, this will return true
	// otherwise false
	isRectTouching( r2d ) {
	...
	// if boarders are exactly touching, this will return false
	// if overlapped it will return true
	// otherwise false
